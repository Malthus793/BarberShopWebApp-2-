<%-- 
    Document   : phone_error_page
    Created on : 22 May 2023, 12:41:04 PM
    Author     : Student
--%>
                ...
                <div class="col-md-8  ms-sm-auto col-lg-9 p-0">
                    <section class=" d-flex justify-content-center align-items-center" id="section_1">
                        ...
                        <div class="container ">
                            ...
                            <p class="pt-5 text-danger">Invalid Phone Numbers</p>
                            
                            <p class="pt-5 muted small">cellphone number must be 10</p>
