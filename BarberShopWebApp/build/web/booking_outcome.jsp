<%-- 
    Document   : booking_outcome
    Created on : 21 May 2023, 4:36:00 PM
    Author     : Student
--%>
                ...
                <nav id="sidebarMenu" class="col-md-4 col-lg-3 d-md-block sidebar collapse p-0">
                    ...
                    <div class="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_1">booking outcome Page</a>
                            </li>
                ...
                <div class="col-md-8  ms-sm-auto col-lg-9 p-0">
                    <section class=" d-flex justify-content-center align-items-center" id="section_1">
                        ...
                        <div class="container ">
                            ...
                            <p class="pt-5">Hi <%= name%>. Your booking has been successfully placed.</p>
