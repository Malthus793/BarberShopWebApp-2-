<%-- 
    Document   : age_range
    Created on : 21 May 2023, 4:15:21 PM
    Author     : Student
--%>
                ...
                <div class="col-md-8  margin-top-login ms-sm-auto col-lg-9 p-0">
                    <section class=" d-flex justify-content-center align-items-center" id="section_1">
                            ...
                            <div class="container mt-5">
                                <h3 class="pb-5">Find customer by age range.</h3>
                                
                                
                                
                                <form class="row g-3 col-md-6"   action="FindCustomerByAgeServlet.do" method="POST">

                                      <div class="mb-3">
                                        <label for="min_age" class="form-label">Min Age : </label>
                                        <input type="text" name="min_age" class="form-control" id="min_age" placeholder="Min age">
                                      </div>

                                      <div class="mb-3">
                                        <label for="max_age" class="form-label">Max Age : </label>
                                        <input type="text" name="max_age" class="form-control" id="max_age" placeholder="Max age">
                                      </div>
