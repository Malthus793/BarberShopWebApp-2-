<%-- 
    Document   : delete_customer_outcome
    Created on : 21 May 2023, 3:29:44 PM
    Author     : Student
--%>
                ...
                <div class="col-md-8  ms-sm-auto col-lg-9 p-0">
                    <section class=" d-flex justify-content-center align-items-center" id="section_1">
                        ...
                        <div class="container ">
                            ...
                            <p class="pt-5">The customer has been successfully deleted.</p>
                              <a href="ViewAllCustomersServlet.do" class="btn btn-success mt-3">Back</a>
                        </div>
